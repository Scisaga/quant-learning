...
```bash
python backend/qlib/examples/nested_decision_execution/workflow.py backtest
```

收集/准备数据（若脚本提供该入口）：

```bash
python backend/qlib/examples/nested_decision_execution/workflow.py collect_data
```
...
```bash
python backend/qlib/examples/nested_decision_execution/workflow.py backtest_highfreq
```
