...
```bash
python backend/qlib/examples/highfreq/workflow.py get_data
```
...
```bash
python backend/qlib/examples/highfreq/workflow.py dump_and_load_dataset
```
...
```bash
qrun backend/qlib/examples/highfreq/workflow_config_High_Freq_Tree_Alpha158.yaml
```
