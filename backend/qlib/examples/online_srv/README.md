...
```bash
python backend/qlib/examples/online_srv/rolling_online_management.py first_run
python backend/qlib/examples/online_srv/rolling_online_management.py routine
python backend/qlib/examples/online_srv/rolling_online_management.py add_strategy
```
...
```bash
python backend/qlib/examples/online_srv/online_management_simulate.py main
```
