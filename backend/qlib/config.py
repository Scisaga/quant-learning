...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # backend/qlib
_REPO_ROOT = Path(__file__).resolve().parents[2]  # quant-learning

## 读取 `.env` 作为环境变量（优先项目根，其次 backend/qlib）
