...
# 确保 backend/qlib 在 path，以支持 backtest.strategy 导入
_QLIB_ROOT = Path(__file__).resolve().parents[1]
...
# backtest.strategy 需 backend/qlib 在 path，上方已插入 _REPO
from backtest.strategy import VolatilityControlledTopkDropoutStrategy
