...
运行（先确保 qlib 数据存在）：
  python backend/qlib/chronos/scripts/qlib_end2end_stub.py
"""
...
# 让 `backend/qlib/chronos/qchronos` 可被直接 import
_ROOT = Path(__file__).resolve().parents[1]  # .../backend/qlib/chronos
